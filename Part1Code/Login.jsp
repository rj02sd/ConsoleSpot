    ...
    <body style="background-color:#DC143C;">
		...
		<%
			try{
				...
				stmt.executeUpdate("INSERT IGNORE INTO END_USERS(END_USERNAME,anon) VALUES('user1', 0)");
				stmt.executeUpdate("INSERT IGNORE INTO END_USERS(END_USERNAME,anon) VALUES('random', 0)");
