...
CREATE TABLE IF NOT EXISTS `BuyMe`.`listings` (
  ...
  `minimum_price` DOUBLE NULL DEFAULT NULL,
  `increment_price` DOUBLE NULL DEFAULT NULL,
  `seller_id` VARCHAR(20) CHARACTER SET 'utf8' NULL DEFAULT NULL,
