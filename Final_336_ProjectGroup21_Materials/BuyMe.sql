...
CREATE TABLE IF NOT EXISTS `BuyMe`.`bidders` (
  ...
  `bidding_increment` DOUBLE NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `BuyMe`.`earnings`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `BuyMe`.`earnings` (
  `listing_id` INT NOT NULL,
  `sold_price` DOUBLE NULL DEFAULT NULL,
  `date` DATETIME NULL DEFAULT NULL,
  UNIQUE INDEX `listing_id_UNIQUE` (`listing_id` ASC) VISIBLE,
  INDEX `listingid_idx` (`listing_id` ASC) VISIBLE,
  CONSTRAINT `listingid`
    FOREIGN KEY (`listing_id`)
    REFERENCES `BuyMe`.`listings` (`listing_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
